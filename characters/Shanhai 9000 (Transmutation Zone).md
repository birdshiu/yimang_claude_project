...
Similarly to the other standard New Kunlun Shanhai, the Factory Shanhai 9000 appears as a short humanoid robot with large spherical aquarium-like head, along with a body that sports a light blue, pink, and yellow color scheme.

Its spherical screen projects a green and yellow fish reminiscent of a porcupinefish or pufferfish, a comparison made more obvious when the projection puffs up before attacking Yi.

When first interacted with, the Factory Shanhai appears to have a friendly disposition, but upon recognizing Yi as an intruder, it begins attacking him. It fires the same crimson laser as Eclipse Sniper Corporals, which can be reflected with the Unbounded Counter. Reflecting the laser destroys the Shanhai, granting the Transmutation Zone Chip for no Jin cost. Destroying it in this way does not prevent the Fortune Teller Machine event from triggering.
